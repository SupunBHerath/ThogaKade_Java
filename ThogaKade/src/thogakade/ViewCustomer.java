...
public class ViewCustomer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        customerListTTable = new javax.swing.JTable();
        ...
        customerListTTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(customerListTTable);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            DefaultTableModel dtm = (DefaultTableModel) customerListTTable.getModel();
            dtm.setRowCount(0);
            while (res.next()) {
                while (res.next()) {
                    Object[] rowData = {
    ...
    private javax.swing.JTable customerListTTable;
